...
<script>
    ...
    $(document).ready(function () {
        $("#shareBtn").click(function () {
            ...
            var URL = 'http://jagwant.only4agents.com/PropertyDetails.aspx?MLSID=' + MLSID + '&PropertyType=' + PropertyType;
    ...
    <div class="col-md-12 col-sm-12">
        <div class="property_top_inner_bg">
            ...
            <div class="col-md-5 col-sm-5">
                           ...
                           <%-- <div id="sharetweet" class="btn btn-success clearfix">Share Me On Tweet</div>--%>
            ...
            <div class="rocco_cntct_info_profile">
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="roco_pro_info">
                        ...
                        <img style="float: left;" src="../img/logo.jpg" />
                    </div>
                </div>
